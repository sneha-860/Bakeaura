    ...
    <Modal open={open} title="Apply to join Bakeaura" onClose={onClose}>
      <form className="form-card" onSubmit={submit}>
        ...
        <div className="field">
          <label className="eyebrow">
            {isInfluencer
              ? 'About your content and audience'
          ...
          <textarea
            ...
            placeholder={
              isInfluencer
                ...
                : 'Tell us about your baking experience, what you specialize in (cakes, cookies, breads?), your kitchen setup, and the area you can deliver to.'
            }
          />
