...
public class AdminController {
    ...
    public ResponseEntity<ApiResponse<UserDto>> updateUserStatus(
        ...
        return ResponseEntity.ok(ApiResponse.ok("User status updated", adminService.updateUserStatus(id, request)));
    }
    ...
    public ResponseEntity<ApiResponse<UserDto>> updateUserRole(
        ...
        return ResponseEntity.ok(ApiResponse.ok("User role updated", adminService.updateUserRole(id, request.getRole())));
    }
